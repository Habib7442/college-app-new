...
const signUp = async (
  ...
  try {
    ...
    const commonData = {
      ...
      isApproved: userType !== "Student" ? true : false,
      isRejected: false,
      qualification: userType !== "Student" ? qualification || "" : "", // Ensure qualification is not undefined
    };
    ...
    switch (userType) {
      ...
      case "Teacher":
        userData = {
          ...
          totalCredits: 0, // Initialize totalCredits as 0
          isAssigned: false,
        };
        break;
      default:
